<template>
  <div>
    ...
    <el-dialog
      ...
      <!-- 树形控件 -->
      <el-tree :data="rightsList" :props="treeProps" show-checkbox :default-expand-all="true" node-key="id" 
...
export default {
  ...
  methods: {
    ...
    async showSetRightDialog(role){
      ...
      // 递归获取3级节点的id
      this,this.getLeafKeys(role, this.defKeys);
